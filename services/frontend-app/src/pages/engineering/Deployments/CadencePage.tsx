...
export default function CadencePage() {
  useDocumentTitle('Engineering - Release Cadence')
        ...
        <main className="flex-1 p-6 ml-16">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="space-y-6">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold text-primary">RELEASE CADENCE</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-secondary border border-default rounded-lg p-4">
                <div className="text-sm text-secondary mb-2">Weekly Cadence</div>
                <div className="h-24 bg-tertiary rounded flex items-center justify-center text-secondary">0</div>
              </div>
              <div className="bg-secondary border border-default rounded-lg p-4">
                <div className="text-sm text-secondary mb-2">Release Rhythm</div>
