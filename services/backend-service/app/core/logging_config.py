...
# 🔧 TOGGLE: Set to True to disable log filters and see ALL debug logs
DISABLE_LOG_FILTERS = False  # Set to True to see all DEBUG logs, False to use keyword filtering
