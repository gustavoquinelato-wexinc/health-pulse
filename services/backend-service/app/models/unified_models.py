...
class MLAnomalyAlert(Base, BaseEntity):
    ...
    # Relationships
    client = relationship("Tenant", back_populates="ml_anomaly_alerts")
...
class QdrantVector(Base, BaseEntity):
    ...
    # Relationships
    client = relationship("Tenant", back_populates="qdrant_vectors")
...
class AIUsageTracking(Base, BaseEntity):
    ...
    # Relationships
    client = relationship("Tenant", back_populates="ai_usage_tracking")
